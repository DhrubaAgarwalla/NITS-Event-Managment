const CACHE_NAME = 'nits-events-v1.0.0';
const STATIC_CACHE = 'nits-events-static-v1.0.0';
const DYNAMIC_CACHE = 'nits-events-dynamic-v1.0.0';
...
self.addEventListener('push', (event) => {
  ...
  event.waitUntil(
    self.registration.showNotification('NITS Events', options)
  );
});
